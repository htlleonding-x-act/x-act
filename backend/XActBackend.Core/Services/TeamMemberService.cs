...
public interface ITeamMemberService
{
    ...
    /// <summary>a different team id in <paramref name="teamMemberData"/> moves the member to that team</summary>
    ...
    /// <summary>a member is either a registered user or a guest, never both</summary>
